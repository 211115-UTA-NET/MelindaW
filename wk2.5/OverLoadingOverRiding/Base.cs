namespace OverrideOverload
{
    public class Base
    {
        ...
        // Overloading - creating multipleversions of a method or constructor,
        // that accept different parameters (number of parameters, types, etc)
        ...
        // Use descriptive name for the methods, but the methods to be overloaded
        //  MUST have the same name.
        // Use descriptive names for the parameters. Use the same name for the same
        //  parameter for each instance of an overloaded method.
        // Send parameters in a consistent order.
        // Do NOT have overloads with parameters at the same position and similar
        //  types, yet with different sematics.


        // AccessModifier Modifier ReturnType MethdName(Parameters)
